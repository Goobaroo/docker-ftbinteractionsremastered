# [FTB Interactions Remastered](https://feed-the-beast.com/modpack/111-ftb_interactions_remastered) By FTB
...
The docker on first run will download the same version as tagged of `FTB Interactions Remastered` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB Interactions Remastered Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-ftbinteractionsremastered

Docker: https://hub.docker.com/repository/docker/goobaroo/ftbinteractionsremastered